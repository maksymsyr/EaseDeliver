...
struct Point
{
	//char row;	// this could be a deliberate bug
	int row;
	//char col;	// this could be a deliberate bug
	int col;
};
...
struct Route
{
	...
	int numPoints;
	int routeSymbol;
	//char routeSymbol;			//should this be int??
};
...
* D = a shortest path or route from one point to another
...
*/
void addPointToRouteIfNot(struct Route* route, const int row, const int col);
...
/// <summary>
/// Validate a Route pointer
/// </summary>
/// <param name="route">the Route pointer</param>
